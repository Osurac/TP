...
public class Carreteras extends ObjetoSimulacion{
	...
	protected List<Vehiculos> vehiculos;
	
	private Comparator<Vehiculos> comparadorVehiculo;
	
	public Carreteras(String id, int length, int maxSpeed, CruceGenerico<?> src, CruceGenerico<?> dest){
		super(id);
	...
	protected int calcularVelocidadBase(){
		return Math.min(this.velocidadMaxima,(this.velocidadMaxima/Math.max(vehiculos.size(),1))+1/1);
	}
	...
	public Object getListaVehiculos() {
		String vehiculos="[";
