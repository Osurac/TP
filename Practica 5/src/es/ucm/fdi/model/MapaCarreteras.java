...
public class MapaCarreteras {
	...
	public void addCarretera(String idCarretera, CruceGenerico<?> origen, Carreteras carretera, CruceGenerico<?> destino) throws ErrorDeSimulacion{
	...
	public String generateReport(int time){
		...
		for(CruceGenerico<?> cruce: cruces){
	...
	public Carreteras getCarretera(String id) throws ErrorDeSimulacion{
	...
	public List<Carreteras> getCarreteras(){
