...
public class ComponenteMapa extends JComponent implements ObservadorSimuladorTrafico {
	...
	private void drawMap(Graphics g) {
		...
		// draw edges
		for (Carreteras e : this.mapa.getCarreteras()) {
			...
			for (Vehiculos d : e.getVehiculos()) {
	...
	private boolean hasGreen(Carreteras e) {
	...
	@Override
	public void addEvento(int tiempo, MapaCarreteras map, List<Evento> eventos) {
		/*SwingUtilities.invokeLater(new Runnable(){
